  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok && data.success) {
        // TIDAK auto-login — user harus login manual dengan kredensial yang baru
        // didaftarkan. Pesan sukses dititipkan lewat sessionStorage, dibaca sekali
        // oleh halaman login lalu dihapus.
        sessionStorage.setItem('sipi_register_success', data.business?.name || businessName.trim());
